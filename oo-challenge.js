...
// The Car class should inherit from Vehicle and each car instance
...
// This class should inherit from Vehicle and each motorcycle instance
// should have a property called numWheels which has a value of 2.
...
// the array of vehicles. However, if you try to add something which is not a vehicle,
...
class Garage {
	...
	add (newVehicle) {
		if (!(newVehicle instanceof Vehicle)) {
			return 'Only new vehicles are allowed in here';
		}
